...
namespace ClassNotes.API.Migrations
{
    ...
    partial class ClassNotesContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassNotes.API.Database.Entities.UserEntity", b =>
                {
                    ...
                    b.Property<Guid?>("CourseSettingEntityId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CourseSettingEntityId");
            ...
            modelBuilder.Entity("ClassNotes.API.Database.Entities.CourseEntity", b =>
                {
                    ...
                    b.HasOne("ClassNotes.API.Database.Entities.CourseSettingEntity", "CourseSetting")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ClassNotes.API.Database.Entities.UserEntity", b =>
                {
                    b.HasOne("ClassNotes.API.Database.Entities.CourseSettingEntity", null)
                        .WithMany("Teachers")
                        .HasForeignKey("CourseSettingEntityId");
